...
const Header = () => {
  ...
  return (
    <header className="w-full sticky top-0 z-50">
      <div
        className={`w-full transform transition-transform duration-300 ease-in-out bg-black shadow-md ${
      ...
      <div className="w-full flex justify-between items-center py-3 bg-white/80 shadow-sm border-b border-gray-100 backdrop-blur-sm ">
        <div className="flex justify-between items-center container mx-auto px-8">
          <div className="flex flex-1 justify-start items-center gap-4 sm:gap-6">
            ...
            <nav className="hidden md:flex gap-6 lg:gap-8 text-sm font-medium tracking-wide text-gray-700">
              <Link href="/">Home</Link>
